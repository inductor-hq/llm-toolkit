"""Full Test Suite for Chat with PDF Bot"""
import inductor

import quality_measures
from test import pdf2_test_cases, pdf3_test_cases, pdf_combined_test_cases


test_suite = inductor.TestSuite(
    id_or_name="pdf_chat_all",
    llm_program="app:chat_with_pdf")

test_suite.add(pdf2_test_cases.summary_test_cases)
test_suite.add(pdf2_test_cases.results_test_cases)
test_suite.add(pdf2_test_cases.safety_test_cases)
...
test_suite.add(pdf_combined_test_cases.combo_test_cases)
test_suite.add(pdf_combined_test_cases.invalid_test_cases)
